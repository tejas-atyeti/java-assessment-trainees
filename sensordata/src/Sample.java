...
import main.java.outliers_detection.CSVOutliersDetector;
...
public class Sample {
    ...
    public static void main(String[] args) {
        ...
        List<OutlierReport> outlierReports = new CSVOutliersDetector().detectOutliers(sensorDataList,thresholdDataList);
